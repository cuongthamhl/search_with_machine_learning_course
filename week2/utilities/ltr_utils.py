        ...
        "query": {
            "rescore_query": {
                "sltr": {
                    "params": {
                        "keywords": user_query,
                        "keywords_exact": '_S ' + user_query + ' S_',
...
def create_feature_log_query(search_query, doc_ids, click_prior_query, featureset_name, ltr_store_name, size=200, terms_field="_id"):
                    ...
                    },
                    {
                        "sltr": {
                            ...
                            "params": {
                                ...
                                "keywords_exact": '_S ' + search_query + ' S_',
                                "click_prior_query": click_prior_query,
                            }
                        }}
                ]
    ...
    # json.dumps(ltr_log_query)
    return ltr_log_query
